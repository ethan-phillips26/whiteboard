// Local corrections, kept apart from the fetched data and re-applied on every
// read so a sync can never quietly undo one. Nothing here reaches Blackboard.
...
/** A stored timestamp as a Date. One with no offset is UTC. */
