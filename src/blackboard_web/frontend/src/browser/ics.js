// ics.py for the browser build. The calendar grid renders this document rather
// than the JSON, exactly as it does against the server, so what is on screen and
// what an exported file puts in a calendar cannot disagree.
...
/** A Date or ISO string as a Date; one with no offset is UTC, as in ics.py. */
...
/** "Fri Sep 04, 11:59 PM", in this machine's time — ics.py's strftime. */
function human(d) {
