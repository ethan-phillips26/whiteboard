// notices.py for the browser build: which announcements have already been popped
// up. In this build the record lives in the browser, because there is nowhere
// else for it — which means a second browser shows a post once more. The first
// run baselines everything silently rather than stacking a term's posts in one
// modal.
