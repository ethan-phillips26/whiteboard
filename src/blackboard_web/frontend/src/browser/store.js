// The browser build's knowledge store: cache.py's shape — {fetched_at, data, …}
// under a key, with the same per-kind TTLs — kept in IndexedDB. localStorage would
...
// How long each kind of fetched data stays fresh, in seconds. Same as cache.py.
export const TTL = {
  courses: 6 * 3600,
  categories: 24 * 3600,
  assignments: 900,
